...
export function KeyboardGuideDialog({ open, onOpenChange }: KeyboardGuideDialogProps) {
  const shortcuts = [
    ...
    { key: "Alt + 1..5", desc: "Pilih Metode: 1:Tunai, 2:QRIS, 3:Transfer, 4:Debit, 5:Hutang (Kasbon)" },
    { key: "Alt + B", desc: "Buka Dialog Bayar Kasbon / Hutang Pelanggan (Tunai & Non-Tunai)" },
